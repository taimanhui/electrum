...
public class CreateWalletPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String WALLET_NAME = "com.haobtc.coldwallet.activities.walletName";
    public static final String COSIGNER_NUM = "com.haobtc.coldwallet.activities.cosignerNum";
    public static final String SIGNUM_REQUIRE = "com.haobtc.coldwallet.activities.sigNumRequire";
