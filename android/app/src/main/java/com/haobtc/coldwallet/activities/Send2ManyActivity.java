...
public class Send2ManyActivity extends AppCompatActivity {
    public static final String TOTAL_AMOUNT = "com.haobtc.coldwallet.activities.Send2ManyActivity.TOTAL";
    public static final String ADDRESS = "com.haobtc.coldwallet.activities.Send2ManyActivity.ADDRESS";
