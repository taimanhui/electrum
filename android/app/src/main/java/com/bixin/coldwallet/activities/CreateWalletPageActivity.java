...
public class CreateWalletPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String WALLET_NAME = "com.bixin.coldwallet.activities.walletName";
    public static final String COSIGNER_NUM = "com.bixin.coldwallet.activities.cosignerNum";
    public static final String SIGNUM_REQUIRE = "com.bixin.coldwallet.activities.sigNumRequire";
