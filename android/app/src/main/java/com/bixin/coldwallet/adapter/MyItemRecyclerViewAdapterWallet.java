package com.bixin.coldwallet.adapter;
...
import com.bixin.coldwallet.fragment.ItemFragmentWallet.OnListFragmentInteractionListener;
...
public class MyItemRecyclerViewAdapterWallet extends RecyclerView.Adapter<MyItemRecyclerViewAdapterWallet.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_item_wallet, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.id_2);
