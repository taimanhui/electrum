...
public class Send2ManyActivity extends AppCompatActivity {
    public static final String TOTAL_AMOUNT = "com.bixin.coldwallet.activities.Send2ManyActivity.TOTAL";
    public static final String ADDRESS = "com.bixin.coldwallet.activities.Send2ManyActivity.ADDRESS";
