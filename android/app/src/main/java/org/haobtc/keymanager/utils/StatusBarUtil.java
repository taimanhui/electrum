...
public class StatusBarUtil {
    ...
    /**
     * Change the status bar to fully transparent
     *
     * @param activity
     */
    @TargetApi(19)
    ...
    /**
     * Modify the color of the status bar to support the version above 4.4
     *
     * @param activity
     * @param colorId
     */
...
//      window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);  
    ...
    /**
     * Status bar light color mode, setting status bar black text and icon,
     * adapting to miuiv, flyme and other Android versions above 4.4 and 6.0
     *
     * @param activity
        ...
        if (window != null) {
            ...
            try {
                ...
                if (dark) {
                    ...
                    extraFlagField.invoke(window, 0, darkModeFlag);//clear black text
                }
                result = true;
