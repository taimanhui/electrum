...
import org.haobtc.keymanager.activities.TransactionRecordsActivity;
import org.haobtc.keymanager.activities.base.ApplicationObserver;
...
import org.haobtc.keymanager.activities.transaction.CheckChainDetailWebActivity;
import org.haobtc.keymanager.adapter.MaindowndatalistAdapetr;
import org.haobtc.keymanager.adapter.UnbackupKeyAdapter;
...
import org.haobtc.keymanager.bean.MainSweepcodeBean;
...
import org.haobtc.keymanager.event.MainpageWalletEvent;
import org.haobtc.keymanager.event.SecondEvent;
import org.haobtc.keymanager.fragment.mainwheel.AddViewFragment;
import org.haobtc.keymanager.fragment.mainwheel.CheckHideWalletFragment;
import org.haobtc.keymanager.fragment.mainwheel.WheelViewpagerFragment;
...
//            Log.i("downMainListdata", "downMaina===: " + e.getMessage());
    ...
    //show trsaction list
    public void showTrsactionlist(String strHistory) {
        maintrsactionlistEvents.clear();
        try {
    ...
    public void showTransactionTest(String strHistory) {
        maintrsactionlistEvents = new ArrayList<>();
        maintrsactionlistEvents.clear();
        try {
            jsonArray = new JSONArray(strHistory);
