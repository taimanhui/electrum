...
import org.haobtc.keymanager.adapter.ChooseUtxoAdapter;
import org.haobtc.keymanager.event.ChooseUtxoEvent;
...
public class ChooseUtxoActivity extends BaseActivity {
    ...
    @BindView(R.id.rel_utxo)
    RelativeLayout relUtxo;
        ...
        try {
            ...
            if (getUnspendUtxos != null && getUnspendUtxos.size() != 0) {
                ...
                if (jsonArray.length() != 0) {
                    ...
                    relUtxo.setVisibility(View.GONE);
