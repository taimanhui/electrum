...
fun getBlockBrowserBscMain(): Map<String, BlockBrowserBscMain> {
  return arrayListOf(
      BlockBrowserBscMain.BscScan()
  ).associateBy { it.uniqueTag() }
}

abstract class BlockBrowserBscMain(val url: String) : ETHBlockBrowser {
  override fun showName() = url()
  override fun url() = url
  override fun uniqueTag() = "${blockBrowserTag()}BSCMain"
  ...
  class BscScan : BlockBrowserBscMain("https://bscscan.com/") {
