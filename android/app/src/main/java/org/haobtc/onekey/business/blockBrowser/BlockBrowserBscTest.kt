...
fun getBlockBrowserBscTest(): Map<String, BlockBrowserBscTest> {
  return arrayListOf(
      BlockBrowserBscTest.BscScan()
  ).associateBy { it.uniqueTag() }
}

abstract class BlockBrowserBscTest(val url: String) : ETHBlockBrowser {
  override fun showName() = url()
  override fun url() = url
  override fun uniqueTag() = "${blockBrowserTag()}BSCTest"
  ...
  class BscScan : BlockBrowserBscTest("https://testnet.bscscan.com/") {
