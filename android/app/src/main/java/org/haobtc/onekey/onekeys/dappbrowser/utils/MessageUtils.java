package org.haobtc.onekey.onekeys.dappbrowser.utils;

import java.io.ByteArrayOutputStream;
import java.io.IOException;
import java.util.regex.Matcher;
import java.util.regex.Pattern;
import org.haobtc.onekey.onekeys.dappbrowser.bean.ProviderTypedData;
import org.web3j.utils.Numeric;

/**
 * @author Onekey@QuincySx
 * @create 2021-03-05 11:02 PM
 */
public class MessageUtils {

    /**
     * Encode params for hashing - the algorithm is very simple, reduce the types like this: (string
     * Message, uint32 value, bytes32 data) into a string list like this: "string Messageuint32
     * valuebytes32 data"
     *
     * @param rawData
     * @return
    ...
    /**
     * This routine ported from the reference implementation code at
