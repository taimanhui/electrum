...
public interface CryptoFunctionsInterface {
    ...
    CharSequence formatTypedMessage(
            ProviderTypedData[] rawData); // see class Utils: Uses Android text formatting

    CharSequence formatEIP721Message(
            String messageData); // see class Utils: Uses web3j: you need to provide this function
    // to decode EIP712.
