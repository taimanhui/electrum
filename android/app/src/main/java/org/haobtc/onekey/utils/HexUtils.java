...
public class HexUtils {
    ...
    public static String bigIntegerToHexString(BigInteger input) {
        return HEX_PREFIX + input.toString(16);
    }
    ...
    @Nullable
    public static String addHexPrefix(@Nullable String input) {
        if (input != null && !containsHexPrefix(input)) {
            input = HEX_PREFIX + input;
        }
        return input;
    }
    ...
    public static String byteArrayToHexString(
            @NonNull byte[] input, int offset, int length, boolean withPrefix) {
