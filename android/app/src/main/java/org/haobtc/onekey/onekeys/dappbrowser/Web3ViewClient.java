...
public class Web3ViewClient extends WebViewClient {
    ...
    private boolean shouldOverrideUrlLoading(
            WebView webView, String url, boolean isMainFrame, boolean isRedirect) {
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        ...
        if (response == null || response.isRedirect) {
            ...
            WebResourceResponse webResourceResponse =
                    new WebResourceResponse(response.mime, response.charset, inputStream);
            synchronized (lock) {
                isInjected = true;
            }
                ...
                () ->
                        view.loadUrl(
                                "javascript:(function() {"
                                        ...
                                        +
                                        // Tell the browser to BASE64-decode the string into your
                                        // script !!!
    ...
    public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
        ...
        aDialog.setMessage("HTTPS 证书有问题");
        aDialog.setButtonText(R.string.confirm);
