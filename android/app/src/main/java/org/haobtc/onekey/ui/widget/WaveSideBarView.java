...
public class WaveSideBarView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = getResources().getColor(R.color.black_0);
        mWaveColor = getResources().getColor(R.color.onekey);
        ...
        mLargeTextSize =
                context.getResources().getDimensionPixelSize(R.dimen.large_textSize_sidebar);
        ...
        if (attrs != null) {
            ...
            mTextColorChoose =
                    a.getColor(
                            R.styleable.WaveSideBarView_sidebarChooseTextColor, mTextColorChoose);
            mTextSize = a.getFloat(R.styleable.WaveSideBarView_sidebarTextSize, mTextSize);
            mLargeTextSize =
                    a.getFloat(R.styleable.WaveSideBarView_sidebarLargeTextSize, mLargeTextSize);
            mWaveColor = a.getColor(R.styleable.WaveSideBarView_sidebarBackgroundColor, mWaveColor);
            mRadius =
                    a.getInt(
                            R.styleable.WaveSideBarView_sidebarRadius,
                            context.getResources().getDimensionPixelSize(R.dimen.radius_sidebar));
            mBallRadius =
                    a.getInt(
                            R.styleable.WaveSideBarView_sidebarBallRadius,
    ...
    private void drawLetters(Canvas canvas) {
        ...
        mLettersPaint.setTypeface(Typeface.DEFAULT_BOLD);
