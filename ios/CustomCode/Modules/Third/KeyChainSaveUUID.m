...
NSString * const KEY_UDID_INSTEAD = @"com.bixin.udid.onekey";

@implementation KeyChainSaveUUID

+(NSString *)getDeviceIDInKeychain {
    NSString *getUDIDInKeychain = (NSString *)[KeyChainSaveUUID load:KEY_UDID_INSTEAD];
    ...
    if (!getUDIDInKeychain ||[getUDIDInKeychain isEqualToString:@""]||[getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [KeyChainSaveUUID save:KEY_UDID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[KeyChainSaveUUID load:KEY_UDID_INSTEAD];
    }
