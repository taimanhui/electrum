...
class TestTiming(TestCase):
    @patch("electrum_gui.common.basic.functional.timing.time.time")
    @patch("electrum_gui.common.basic.functional.timing.uuid.uuid4")
    @patch("electrum_gui.common.basic.functional.timing.threading.current_thread")
