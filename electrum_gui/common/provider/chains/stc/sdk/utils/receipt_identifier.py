...
from electrum_gui.common.provider.chains.stc.sdk.starcoin_types import AccountAddress
from electrum_gui.common.provider.chains.stc.sdk.utils import bech32, utils
...
class ReceiptIdentifier:
    ...
    def __init__(self, account_address: AccountAddress, auth_key: Union[AuthKey, None]):
    ...
    def decode(s: str) -> "ReceiptIdentifier":
        ...
        if version != 1:
            return None
        address = AccountAddress.from_hex(bytearray(data[0 : utils.ACCOUNT_ADDRESS_LEN]).hex())
